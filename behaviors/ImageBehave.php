...
namespace szrama\yii2images\behaviors;
...
use szrama\yii2images\models;
use yii\helpers\BaseFileHelper;
use \szrama\yii2images\ModuleTrait;
...
class ImageBehave extends Behavior
{
    ...
    public function attachImage($absolutePath, $isMain = false)
    {
        ...
        if(
            is_object($img) && get_class($img)=='szrama\yii2images\models\PlaceHolder'
            or
            $img == null
            or
            $isMain
